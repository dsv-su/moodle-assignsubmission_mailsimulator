...
$string['editcontacts'] = 'Edit contacts';
$string['editmail'] = 'Edit mail';
$string['edittemplate'] = 'Edit template';
$string['enabled'] = 'Mail Simulator';
$string['enabled_help'] = 'If enabled, students are able to work with Mail Simulator.';
$string['error_mid'] = 'Incorrect mail id';
$string['error_edit'] = 'You are not allowed to edit this mail';
$string['error_setup'] = 'Assignment needs to be setup correctly, contact your teacher';
...
$string['err_reciever'] = 'Chose at least 1 reciever.';
